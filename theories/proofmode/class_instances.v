...
Proof.
  ...
  by rewrite !later_affinely_persistently_if_2 (later_intro (□?p R)%I) -later_wand HR.
Qed.
...
Proof.
  rewrite /IntoWand' /IntoWand /= => HR.
  by rewrite !laterN_affinely_persistently_if_2 (laterN_intro _ (□?p R)%I) -laterN_wand HR.
Qed.
